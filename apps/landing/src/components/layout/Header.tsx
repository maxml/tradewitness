            ...
            <nav className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="flex items-center space-x-2">
                        <a href={process.env.NEXT_PUBLIC_APP_URL || "http://localhost:3001"} className="px-4 py-2 text-sm font-medium text-white bg-neutral-900 dark:bg-white dark:text-neutral-900 rounded-lg hover:bg-neutral-800 dark:hover:bg-neutral-100 transition-colors">
                            Go to App
                        </a>
                        <LanguageToggle />
                        <ThemeToggle />
